...
import { SolucionComponent } from 'app/entities/solucion/solucion.component';
  ...
  describe('Solucion Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SolucionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.solucions && comp.solucions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
