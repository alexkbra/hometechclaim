...
import co.com.hometechclaim.repository.DispositivoRepository;
...
public class DispositivoResourceIT {
    ...
    private static final String DEFAULT_IDDEALER = "AAAAAAAAAA";
    private static final String UPDATED_IDDEALER = "BBBBBBBBBB";
    ...
    public void createDispositivo() throws Exception {
        ...
        assertThat(testDispositivo.getIddealer()).isEqualTo(DEFAULT_IDDEALER);
    ...
    public void getAllDispositivos() throws Exception {
        ...
        restDispositivoMockMvc.perform(get("/api/dispositivos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].iddealer").value(hasItem(DEFAULT_IDDEALER)))
    ...
    public void getDispositivo() throws Exception {
        ...
        restDispositivoMockMvc.perform(get("/api/dispositivos/{id}", dispositivo.getId()))
            ...
            .andExpect(jsonPath("$.iddealer").value(DEFAULT_IDDEALER))
    ...
    public void updateDispositivo() throws Exception {
        ...
        assertThat(testDispositivo.getIddealer()).isEqualTo(UPDATED_IDDEALER);
