...
import { ComercialesComponent } from 'app/entities/comerciales/comerciales.component';
...
describe('Component Tests', () => {
  describe('Comerciales Management Component', () => {
    let comp: ComercialesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ComercialesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.comerciales && comp.comerciales[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
