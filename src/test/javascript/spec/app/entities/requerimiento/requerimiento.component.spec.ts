...
import { RequerimientoComponent } from 'app/entities/requerimiento/requerimiento.component';
...
describe('Component Tests', () => {
  describe('Requerimiento Management Component', () => {
    let comp: RequerimientoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RequerimientoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.requerimientos && comp.requerimientos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
