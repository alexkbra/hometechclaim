...
import { NovedadComponent } from 'app/entities/novedad/novedad.component';
...
describe('Component Tests', () => {
  describe('Novedad Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.novedads && comp.novedads[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
