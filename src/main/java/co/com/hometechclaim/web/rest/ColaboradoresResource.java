...
/**
 * REST controller for managing {@link co.com.hometechclaim.domain.Colaboradores}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ColaboradoresResource {
    ...
    public ColaboradoresResource(ColaboradoresRepository colaboradoresRepository) {
