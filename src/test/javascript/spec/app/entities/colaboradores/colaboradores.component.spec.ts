...
import { ColaboradoresComponent } from 'app/entities/colaboradores/colaboradores.component';
...
describe('Component Tests', () => {
  describe('Colaboradores Management Component', () => {
    let comp: ColaboradoresComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ColaboradoresComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.colaboradores && comp.colaboradores[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
