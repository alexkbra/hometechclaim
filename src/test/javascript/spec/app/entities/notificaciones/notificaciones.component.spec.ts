...
import { NotificacionesComponent } from 'app/entities/notificaciones/notificaciones.component';
...
describe('Component Tests', () => {
  describe('Notificaciones Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.notificaciones && comp.notificaciones[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
